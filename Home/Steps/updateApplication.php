            ...
            <?php foreach ($clientView->getClientData() as $data) :  ?>
                ...
                <div class="col-md-12 d-flex container-head">
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <input type="text" name="house-no" id="house-no" value="<?php echo $data['house_no'] ?>">
                    </div>
                    <div class="col-md-4 d-flex flex-column">
                    ...
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <input type="text" name="barangay" id="barangay" value="<?php echo $data['barangay'] ?>">
                    </div>
                </div>
                ...
                <div class="col-md-12 d-flex container-head">
                    ...
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <input type="text" name="municipality" id="municipality" value="<?php echo $data['municipality'] ?>">
                    </div>
                </div>
                ...
                <div class="col-md-12 d-flex flex-column container-head">
                    ...
                    <div class="col-md-12 d-flex">
                        <div class="col-md-4 d-flex flex-column">
                            ...
                            <input type="text" name="company-name" id="company-name" value="<?php echo $data['company_name'] ?>">
                        </div>
                        <div class="col-md-4 d-flex flex-column">
                            <label for="company-address">Company Address:</label>
                            <input type="text" name="company-address" id="company-address" value="<?php echo $data['company_address'] ?>">
                        </div>

                        <div class="col-md-4 d-flex flex-column">
                            <label for="company-phone-no">Company Phone No:</label>
                            <input type="text" name="company-phone-no" id="company-phone-no" value="<?php echo $data['company_no1'] ?>">
                        </div>
                ...
                <div class="col-md-12 d-flex container-head">
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <input type="date" name="joining-date" id="joining-date" value="<?php echo $data['date_hire'] ?>">
                    </div>
                    <div class="col-md-4 d-flex flex-column">
                        <label for="industry">Industry:</label>
                        <input type="text" name="industry" id="industry" value="<?php echo $data['line_of_business'] ?>">
                    </div>

                    <div class="col-md-4 d-flex flex-column">
                        <label for="position-in-company">Position in Company:</label>
                        <input type="text" name="position-in-company" id="position-in-company" value="<?php echo $data['position'] ?>">
                    </div>
                </div>
                ...
                <div class="col-md-12 d-flex container-head">
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <input type="text" name="gross-monthly-income" id="gross-monthly-income" value="<?php echo $data['basic_salary'] ?>">
                    </div>
                    <div class="col-md-4 d-flex flex-column">
                        <label for="pay-date1">Pay Date 1:</label>
                        <input type="date" name="pay-date1" id="pay-date1" value="<?php echo $data['pay_date1'] ?>">
                    </div>

                    <div class="col-md-4 d-flex flex-column">
                        <label for="pay-date2">Pay Date 2:</label>
                        <input type="date" name="pay-date2" id="pay-date2" value="<?php echo $data['pay_date2'] ?>">
                    </div>
                </div>
                ...
                <div class="col-md-12 d-flex flex-column container-head">
                    ...
                    <div class="col-md-12 d-flex">
                        <div class="col-md-4 d-flex flex-column">
                            ...
                            <input type="text" name="loan-amount" id="loan-amount" value="<?php echo $data['requested_amount'] ?>">
                        </div>
                        <div class="col-md-4 d-flex flex-column">
                            <label for="term-type">Term type:</label>
                            <input type="text" name="term-type" id="term-type" value="<?php echo $data['requested_term'] ?>">
                        </div>
                ...
                <div class="col-md-12 d-flex flex-column container-head">
                    ...
                    <div class="col-md-12 d-flex">
                        <div class="col-md-4 d-flex flex-column">
                            ...
                            <input type="text" name="morning" id="morning" value="<?php echo $data['call_time_morning'] ?>">
                        </div>
                        <div class="col-md-4 d-flex flex-column">
                            <label for="afternoon">Afternoon</label>
                            <input type="text" name="afternoon" id="afternoon" value="<?php echo $data['call_time_afternoon'] ?>">
                        </div>
                    </div>
                </div>

                <div class="col-md-8 container-head">
