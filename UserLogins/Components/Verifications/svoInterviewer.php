...
<head>
    ...
    <script src="../../Js/svoInterviewer.js" defer></script>
                                ...
                                <div class="alternate-number-box">
                                    ...
                                    <div class="postpaid-prepaid-box">
                                        <label for="postpaid-alternate">
                                            <input type="radio" name="postpaid-prepaid-alternate" id="postpaid-alternate" value='Postpaid' <?php if ($key['secondary_no_line'] == 'Postpaid' || $key['primary_no_line'] == '') {
                                                                                                                                                echo 'Checked ';
                                                                                                                                            } ?>> Postpaid
                                        </label>
                                ...
                                <div class="container-right">
                                    <div class="container-expneses">
                                        ...
                                        <div class="total-netpay">
                                            <input class="netpay" type="text" name="total-net" disabled id="total-net" value="<?php echo $key['netpay']; ?>">
                        ...
                        <div id="character-references" data-tab-content>
                            ...
                            <div class="flex-box-17">
                                <div class="container-box-1">
                                    ...
                                    <div class="reference-box-1">
                                        <input type="text" id="reference-relationship-3" data-validation name="reference-relationship-3" value="<?php echo $key['char_ref1_relationship']; ?>">
                                        ...
                                        <input type="text" name="application-id" hidden value="<?php echo $key['application_no']; ?>" />
                                    </div>
                                </div>
                            </div>
