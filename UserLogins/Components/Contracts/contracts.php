<?php
require_once('./contractsHeader.php');
...
<section class="container-body">
    ...
    <div class="container-1st">
        <table class="active" data-tab-content id="table-details-fresh">
            ...
            <tbody>
                <tr>
                    <?php if (count($viewDetails->showForContractsApplication()) == 0) : ?>
                        <td></td>
                </tr>
            </tbody>
        </table>
...
<?php else : ?>
    <?php foreach ($viewDetails->showForContractsApplication() as $viewDetail) : ?>
...
<div class="view-details <?php echo $active ?>" id="view-details">
    <form method="post" enctype="multipart/form-data">
        <?php foreach ($viewDetails->view_single_client_details() as $viewDetail) : ?>
                        ...
                        <div class="view-details-right-top">
                            <div class="container-attachment">
                                <fieldset class="fieldAttachment">
                                    ...
                                    <div class="view-uploaded-file save-attachments">
                                        <a class="btn btn-primary" href="./imageContracts.php?application_no=<?php echo $viewDetail['application_no'] . '&filename=Contracts'; ?>" target="_blank" rel="noopener noreferrer">Contract</a>
                                        <a class="btn btn-primary" href="./imageContracts.php?application_no=<?php echo $viewDetail['application_no'] . '&filename=Merge_Contracts'; ?>" target="_blank" rel="noopener noreferrer">Merge Contracts</a>
                                    </div>
                                    <div class="file-upload upload-attachments">
                                        <div class="file-upload-container">
                                            <input type="file" name="file-merge-contracts" id="govt-id" />
                                            <label>*File type must be maximum of 25mb* - MERGE CONTRACTS</label>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="container-textArea">
                                <fieldset class="fTextArea">
                                    ...
                                    <textarea class="textArea" name='remarks'><?php echo $viewDetail['contract_remarks']; ?></textarea>
                                </fieldset>
                            </div>
                            ...
                            <div class="container-view-button" id="container-view-button">
                                <button type="button" class="btn btn-info" id='forward-contracts'>Forward</button>
